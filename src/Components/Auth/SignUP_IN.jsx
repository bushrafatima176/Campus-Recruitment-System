                            ...
                            <div className="card z-depth-2">
                                <form onSubmit={this.onAdd}>
                                    <div className="card-content blue lighten-5">
                                        <div className="card-title z-depth-1 center blue darken-4 white-text">{this.state.Status} Sign In</div>
                                        <br />
                                    ...
                                    <div className="card-action blue lighten-5">
                                        <Button cn="btn form_bu waves-effect waves-light blue darken-3" t="Sign in" />
                                        {this.state.Status === "Admin" ? (null) : (<Fragment> <span className="grey-text darken-1">Don't have an account?</span>  &nbsp; <An cn="blue-text text-darken-2 form_a text" t="Sign up" oc={this.whenClick} /> </Fragment>)}
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    {this.state.SignUp ? (<div className="row">
                        <div className="col s12 m6 l6 offset-l3 offset-m3">
                            <div className="card z-depth-2">
                                <form onSubmit={this.onAdd}>
                                    <div className="card-content blue lighten-5">
                                        <div className="card-title z-depth-1 center blue darken-4 white-text">{this.state.Status} Sign Up</div>
                                        <br />
                                    ...
                                    <div className="card-action blue lighten-5">
                                        <Button cn="btn form_bu waves-effect waves-light blue darken-3" t="Sign up" />
                                        <span className="grey-text darken-1">Already have an account?</span> &nbsp; <An cn="blue-text text-darken-2 form_a text" t="Sign in" oc={this.WhenClick} />
                                    </div>
                                </form>
                            </div>
                        </div>
