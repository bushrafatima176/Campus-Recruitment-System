                      ...
                      <li className="collection-item">
                        ...
                        {this.state.showSpecificStudents ?
                          (<div className="center">
                            <button className="btn-small waves-effect waves-light blue darken-1" onClick={this.showAll}>All Students</button>
                          </div>) : null
                        }
                      </li>
                        ...
                        this.props.allStudents.map((stu, index) => {
                          return (
                            <li key={index} className="collection-item avatar">
                              <i className="btn btn-floating waves-effect waves-light blue material-icons circle" onClick={() => this.details(stu.id, stu.userId)}>person</i>
